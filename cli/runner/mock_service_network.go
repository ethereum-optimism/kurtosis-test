...
func (_m *MockServiceNetwork) GetApiContainerInfo() *service_network.ApiContainerInfo {
	ret := _m.Called()

	var r0 *service_network.ApiContainerInfo
	if rf, ok := ret.Get(0).(func() *service_network.ApiContainerInfo); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*service_network.ApiContainerInfo)
		}
	}
...
func (_c *MockServiceNetwork_GetApiContainerInfo_Call) Return(_a0 *service_network.ApiContainerInfo) *MockServiceNetwork_GetApiContainerInfo_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockServiceNetwork_GetApiContainerInfo_Call) RunAndReturn(run func() *service_network.ApiContainerInfo) *MockServiceNetwork_GetApiContainerInfo_Call {
	_c.Call.Return(run)
	return _c
}
